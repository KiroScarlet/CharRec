...
tf.app.flags.DEFINE_integer('image_height', 60, 'imgs height')
tf.app.flags.DEFINE_integer('image_width', 180, 'imgs width')
tf.app.flags.DEFINE_integer('image_channel', 1, 'imgs channels as input')

tf.app.flags.DEFINE_integer('cnn_count', 4, 'count of cnn module to extract imgs features.')
    ...
    def __init__(self, data_dir):
        ...
        for root, sub_folder, file_list in os.walk(data_dir):
            for file_path in file_list:
                ...
                # imgs is named as /.../<folder>/00000_abcd.png
